  ...
  return (function () {
    ...
    class C {
      ...
      init() {
        ...
        (i &&
          ...
          null !== (e = this.customData) && void 0 !== e && e.disabled
            ? this.dp.disableDate(this.date)
            : !1 ===
                (null === (t = this.customData) || void 0 === t
                  ? void 0
                  : t.disabled) && this.dp.enableDate(this.date));
      }
      ...
      _getClassName() {
        ...
        let t = new Date(),
          ...
          { minDate: n, maxDate: r, isDateDisabled: h } = this.dp,
          { day: l } = o(this.date),
      ...
      _handleRangeStatus() {
        ...
        let h = u({
          "-in-range-":
            n && r && ((o = this.date), (l = n), (d = r), m(o, l) && v(o, d)),
    ...
    class L {
      constructor() {
        ...
        (s && (s.match($("h")) || s.match($("hh"))) && (this.ampm = !0),
          this.init());
      }
      init() {
    ...
    class R {
            ...
            (r._createMinMaxDates(),
              ...
              !s.buttons && h
                ...
                : s.buttons && !h
                  ...
                  : c && s.buttons && h && r.buttons.clearHtml().render(),
              !s.isMobile && d
      ...
      init() {
        ...
        ((!B || (B && P && !o.contains(P))) &&
          ...
          this.elIsInput &&
            (i || this._bindEvents(),
            r && !h && (this.keyboardNav = new O({ dp: this, opts: e }))),
      ...
      selectDate(e) {
        ...
        if ((e = b(e)) instanceof Date) {
          if (v && !o && !v({ date: e, datepicker: this }))
      ...
      _handleAlreadySelectedDates(e, t) {
        let { selectedDates: i, rangeDateFrom: s, rangeDateTo: a } = this,
          ...
          h = i.length,
          o = "function" == typeof r ? r({ datepicker: this, date: t }) : r,
          l = Boolean(n && 1 === h && e),
          d = l ? g(t) : t;
        (n && !o && (2 !== h && this.selectDate(d), 2 === h && p(s, a))) ||
          (o ? this.unselectDate(d) : this._updateLastSelectedDate(l ? d : e));
      }
